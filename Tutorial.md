...
Para crear una base de datos primero hemos de diseñar la estructura de la base de datos, para ello pensaremos en dos tablas que inicialmente van a contener a los clientes y otra que va a contener algunos parámetros que los clientes deseen compartir en la página. A estas tablas las llamaremos **Customer** y **Parameters** respectivamente.  
